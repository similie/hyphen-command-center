<script lang="ts">
  import { type SiteConfig, type UserModel } from "$lib";
  import {
    Text,
    Button,
    Html,
  ...
  export let user: Partial<UserModel>;
...
<Html lang="en">
  ...
  <Body>
    <Container>
      ...
      <Text>
        You had a new account created for you on
        {config?.siteName || "Similie Services"}. Click the link below to login
        to your account.
      </Text>
